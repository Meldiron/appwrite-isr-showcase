 ...
 *
 * `X-Appwrite-Cache-Control` mirrors `Cache-Control` semantics, but is only
...
export const GET: APIRoute = () => {
  ...
  return new Response(
    JSON.stringify({
      ...
      strategy: 'X-Appwrite-Cache-Control: public, max-age=60',
    ...
    }),
    {
      ...
      headers: {
        ...
        'X-Appwrite-Cache-Control': 'public, max-age=60',
      },
    },
  );
};
